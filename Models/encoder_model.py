...
class encoder_param():
    def __init__(self,num_voxels, c2f_l1 = 5e-6,c2f_gl = 1e-5,lc_l1 = 5e-6,lc_l1_out = 5e-2,conv_l1_reg = 1e-5,conv_l2_reg = 0.001,fc_reg_l1 = 20,fc_reg_gl = 800):
        self.num_voxels = num_voxels
        self.resolution = 112
        self.conv_l1_reg = conv_l1_reg
        self.conv_l2_reg = conv_l2_reg
        self.fc_reg_l1 = fc_reg_l1#1e-6 #20
        self.fc_reg_gl = fc_reg_gl#1.5e-4 #800
