...
class encoder_param():
    def __init__(self,num_voxels,c2f_l1 = 1e-7,c2f_gl = 1e-7,lc_l1 = 1e-7 ,lc_l1_out = 1e-7,conv_l1_reg = 1e-5,conv_l2_reg = 0.001):
        ...
        #seperable model
        self.c2f_l1 = c2f_l1 #5e-6
        self.c2f_gl = c2f_gl#1e-5
        self.lc_l1 = lc_l1 #5e-6
        self.lc_l1_out = lc_l1_out #5e-2
        self.patch = 3
